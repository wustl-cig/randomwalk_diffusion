# A Unified Algorithmic Template for Diffusion Models
...
and leads to unified algorithmic templates for network training and sampling.
...
```
conda create -n Template python=3.9.19
